window.onload = function () {
    ...
    var balletPersonLink = document.getElementById("ballet-person");
    balletPersonLink.onclick = function () {
        showVideos(0, videosContainer.getElementsByClassName("ballet"));
    }

    var modernoPersonLink = document.getElementById("moderno-person");
    modernoPersonLink.onclick = function () {
        showVideos(0, videosContainer.getElementsByClassName("moderno"));
    }

    var hiphopPersonLink = document.getElementById("hiphop-person");
    hiphopPersonLink.onclick = function () {
        showVideos(0, videosContainer.getElementsByClassName("hiphop"));
    }
